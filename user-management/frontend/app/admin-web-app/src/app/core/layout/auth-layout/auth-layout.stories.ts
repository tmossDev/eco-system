      ...
      <main class="auth-layout-story">
        <section class="brand-panel-story" aria-label="Application information">
          <div class="brand-content-story">
            <a href="/" class="brand-mark-story" aria-label="Admin Web App home">
              <span class="brand-icon-story">A</span>
              <span>Admin Web App</span>
            </a>

            <div class="brand-message-story">
              <p class="eyebrow-story">User management</p>
              <h1>Manage users with confidence.</h1>
              <p>
                Securely access your admin tools, review user accounts, and keep your
                workspace organised.
              </p>
            </div>
