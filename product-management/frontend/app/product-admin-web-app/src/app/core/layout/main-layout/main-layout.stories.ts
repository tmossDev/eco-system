...
@Component({
  selector: 'app-main-layout-story-products',
  template: `
    <section class="story-page">
      <div class="page-header">
        <div>
          ...
          <h1>Products</h1>
          <p class="description">
            This route preview shows a simple products table inside the main layout.
          </p>
        </div>
      </div>
    ...
    <section class="story-page">
      ...
      <form class="settings-card">
        <label>
          ...
          <input type="text" value="Product Admin Web App" />
        </label>
        ...
        provideRouter([
          {
            ...
            children: [
              ...
              {
                path: 'products',
                component: MainLayoutStoryProducts,
              },
              {
                path: 'settings',
...
export const Products: Story = {
  render: () => ({
    template: `
      <app-main-layout>
        <app-main-layout-story-products />
      </app-main-layout>
    `,
  }),
};
