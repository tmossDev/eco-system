      ...
      <main class="auth-layout-story">
        <section class="brand-panel-story" aria-label="Application information">
          <div class="brand-content-story">
            <a href="/" class="brand-mark-story" aria-label="Product Admin Web App home">
              <span class="brand-icon-story">A</span>
              <span>Product Admin Web App</span>
            </a>

            <div class="brand-message-story">
              <p class="eyebrow-story">Product management</p>
              <h1>Manage products with confidence.</h1>
              <p>
                Securely access your admin tools, review catalog items, and keep your
                workspace organised.
              </p>
            </div>
            ...
            <div class="feature-list-story">
              <div class="feature-item-story">
                <span>✓</span>
                <p>Centralised user administration</p>
              </div>

              <div class="feature-item-story">
                <span>✓</span>
                <p>Role and access management</p>
              </div>
