  ...
  template: `
    <section class="settings-page">
      <div class="page-header">
        ...
        <h1>Settings</h1>
        <p class="description">
          Manage catalog defaults for product administration.
        </p>
      </div>
      ...
      <form class="settings-card" (ngSubmit)="saveSettings()">
        ...
        <label>
          ...
          <input
            ...
            [ngModel]="settings().defaultCategory"
            (ngModelChange)="updateSetting('defaultCategory', $event)"
          />
        </label>
        ...
        <label>
          ...
          <input
            ...
            [ngModel]="settings().defaultCurrencyCode"
            (ngModelChange)="updateSetting('defaultCurrencyCode', $event)"
          />
        </label>
        ...
        <div class="toggle-row">
          <div>
            ...
            <p>Highlight products with low stock during catalog reviews.</p>
          </div>

          <input
            type="checkbox"
            name="inventoryAlerts"
            [ngModel]="settings().inventoryAlerts"
            (ngModelChange)="updateSetting('inventoryAlerts', $event)"
          />
        </div>

        <div class="toggle-row">
          <div>
            <strong>Require review for new products</strong>
            <p>New catalog items start as drafts until an admin publishes them.</p>
          </div>

          <input
            type="checkbox"
            name="requireReview"
            [ngModel]="settings().requireReview"
            (ngModelChange)="updateSetting('requireReview', $event)"
          />
        </div>
